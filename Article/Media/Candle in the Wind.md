---
source_title: Candle in the Wind
categories:
- Media
...
```
```
　　Video: [Elton John - Candle in the Wind/Goodbye England's Rose (Live at Princess Diana's Funeral - 1997)](https://<!-- template: SERVERNAME -->/mwbbs/obj.php?p=video&f=Candle_in_the_Wind_by_Elton_John.mp4)
```
